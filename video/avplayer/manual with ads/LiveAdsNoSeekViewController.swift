...
class LiveAdsNoSeekBarViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        setNavigationBarTitle(title: "Live No Seek with ads")
        delegate = self
...
extension LiveAdsNoSeekBarViewController: BaseViewControllerDelegate {
